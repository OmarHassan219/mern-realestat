...
console.log(error.message);
      ...
      {userListings &&
        ...
        <div className="flex flex-col gap-4">
         ...
         { userListings.map((listing) => (
            <div key={listing._id} className="border flex gap-4 justify-between items-center rounded-lg p-3">
  ...
  <button className="text-red-700 uppercase">Edit</button>
        ...
        </div>): <p className="text-red-700">No Listings to show. Try to add some</p>
}
    </div>
  );
};
